...
export const getPhantomConnectResponse = async (
...
export const getPhantomLinkResponse = async (
    payload?: PhantomLinkRequest,
): Promise<PhantomLinkResponse> => {
...
export const getPhantomCheckoutResponse = async (
